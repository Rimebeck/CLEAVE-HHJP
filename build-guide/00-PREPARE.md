...
| 方法 | 用意するもの | 参照先 |
|---|---|---|
| 標準ケース（3Dプリント） | 配布STL、3Dプリント部品、インサートナット、M2ネジ、フォームテープなど | [標準ケースビルドガイド](03-CASE.md) |
| 簡易ケースキット | 簡易ケースキット、M2ネジ、スペーサー固定用の両面テープなど | [簡易ケースビルドガイド](03-1-SIMPLE_CASE.md) |
| オリジナルケース（STEP参照） | PCB外形STEPデータ、CAD環境、独自に設計・製作したケース部品 | [オリジナルケース作成ガイド](03-2-CUSTOM_CASE.md) |
