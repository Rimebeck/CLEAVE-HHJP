...
| 位置合わせ用 | ピンヘッダ（2.54mmピッチ） | 必要分 |  | XIAO nRF52840 Plus実装時の位置合わせに一時使用します。仮止め後に抜き取り、本実装には使用しません。 |
...
| フォームテープ | フォームテープ2mm厚/3mm幅 | 2m程度 |  | 幅広のテープをカットして使うことも可能です。 |
...
- [ ] デフォルトケース部品の用意方法（自家プリント / 3Dプリントサービスに発注）を決めた
