...
標準ケースを作る場合は、以下の3Dプリント部品を用意します。印刷前に、使用するキースイッチの種類とトップカバーのタイプを決めます。

- **使用するキースイッチの種類**: MX互換スイッチ、またはChocV1/V2互換スイッチを選びます。選択したスイッチに合わせてトッププレートを選びます。後から相互に変更できるため、両方のトッププレートを印刷しておいて切り替えもできます。
- **トップカバーのタイプ**: インジケーター穴あり、または穴なしを選びます。穴ありを選んだ場合は、ケース組み立て時に透明プラ棒を取り付けます。穴なしまたはトップカバーに透明素材を使う場合は不要です。
