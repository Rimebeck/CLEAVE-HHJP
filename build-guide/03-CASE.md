...
### 6. 電源スイッチの取り付け
ケースの内側から電源スイッチを差し込みます。

### 7. PCBの取り付け
ベースケースにPCBとトッププレートとキースイッチがいったいになった部品を装着します。
電源スイッチの窪みにPCBの電源スイッチのノブが刺さるようにスライドさせながらはめ込みます。
トッププレートのフチがベースケースにぴったり合うように調整し、左右それぞれ4箇所を todo；長さ　mmのネジで止めます。
...
### 9. インジケーターの取り付け
穴がないトップカバーを使う場合はスキップ
直径2mm透明プラ棒3をトップカバーに差し込みます。
接着はまだしません。

### 10. トップカバーの取り付け
トップカバーをベースケースに3箇所ネジ止めします。
インジケーターを付けた場合はここでPCBとインジケーターの隙間を調整し、上面にでている不要な文はニッパーなどで切って調整したあとに接着剤などを使って裏側から接着してください。
