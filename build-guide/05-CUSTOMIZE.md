...
この章ではCLEAVE HHJPのキーマップやファームウェア設定を変更する方法をまとめます。

> [!NOTE]
> 初期キーマップのまま使う場合、このガイドの作業は必須ではありません。
> キー配置やファームウェア設定を確認したくなったときに参照してください。
