# CLEAVE HHJP 標準ケースビルドガイド

[目次に戻る](README.md)

配布されている3Dモデルを3Dプリントして、CLEAVE HHJP の標準ケースを作成する方法について説明します。
...
3Dプリント部品、ケース部材、素材の選び方は[準備ガイドのケース関連](00-PREPARE.md#ケース関連)にまとめています。
...
### 1. ケース部品の確認
組み立てを始める前に、準備ガイドで決めた構成の部品が揃っていることを確認します。
...
インサートナットは細い方をケース側に向けて差し込みます。
<img src="./images/case/02/direction.jpg" alt="インサートナットの向き" width="600px">

はんだごてのこて先でインサートナットを温めながら、ケースの穴にまっすぐ押し込みます。
ナットの上面がケースの天面と同じ高さになるまで押し込み、はんだごてを抜きます。
このときにピンセットなどでナットが抜けないようにナットの上面を押さえながらはんだごてを抜くと確実です。
<img src="./images/case/02/1.jpg" alt="はんだごてでインサートナットを熱圧入している状態" width="600px">
...
FDMプリントなど熱収縮がある素材と3Dプリント方法の場合、プラ棒が入らない場合があるため、カッターやドリルなどで穴径を広げます。
接着はまだしません。
