...
| 充電LEDが点灯しない | 満充電で消灯している場合を除き、USBケーブル、USBポート、バッテリー固定を確認します。標準ケースは[標準ケースガイドのバッテリー固定](03-CASE.md#8-バッテリーの固定)、簡易ケースは[簡易ケースガイドのバッテリー固定](03-1-SIMPLE_CASE.md#7-バッテリーの固定)、オリジナルケースは[設計時のチェックポイント](03-2-CUSTOM_CASE.md#設計時のチェックポイント)を確認してください。 |
...
|---|---|---|---|
| 標準ケース | M2 8mm | M2 10mm | [標準ケースビルドガイド](03-CASE.md) |
...
2. キーキャップを外します。
3. 標準ケースビルドガイドの[10. トップカバーの取り付け](03-CASE.md#10-トップカバーの取り付け)を参考に、トップカバーのM2 4mmネジを外してトップカバーを外します。簡易ケースキットの場合は[簡易ケースガイドの8. トップカバーの取り付け](03-1-SIMPLE_CASE.md#8-トップカバーの取り付け)を参考にします。
...
7. 交換先のトッププレートに交換先のスイッチをはめ込みます。標準ケースでは[標準ケースガイドの4. キースイッチ取り付け](03-CASE.md#4-キースイッチ取り付け)、簡易ケースでは[簡易ケースガイドの4. キースイッチ取り付け](03-1-SIMPLE_CASE.md#4-キースイッチ取り付け)から進めます。
8. 標準ケースでは続けて[5. トッププレートの取り付け](03-CASE.md#5-トッププレートの取り付け)、[7. PCBの取り付け](03-CASE.md#7-pcbの取り付け)、[8. バッテリーの固定](03-CASE.md#8-バッテリーの固定)、[10. トップカバーの取り付け](03-CASE.md#10-トップカバーの取り付け)、[11. キーキャップの取り付け](03-CASE.md#11-キーキャップの取り付け)を行います。簡易ケースでは[5. トッププレートの取り付け](03-1-SIMPLE_CASE.md#5-トッププレートの取り付け)、[6. PCBの取り付け](03-1-SIMPLE_CASE.md#6-pcbの取り付け)、[7. バッテリーの固定](03-1-SIMPLE_CASE.md#7-バッテリーの固定)、[8. トップカバーの取り付け](03-1-SIMPLE_CASE.md#8-トップカバーの取り付け)を行います。
...
- [前（標準ケース）: 標準ケースビルドガイド](03-CASE.md)
