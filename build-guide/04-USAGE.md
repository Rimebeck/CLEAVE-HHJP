...
| 充電LEDが点灯しない | 満充電で消灯している場合を除き、USBケーブル、USBポート、[ケースガイドのバッテリー固定](03-CASE.md#8-バッテリーの固定)を確認します。 |
...
| 右側のLED | 左右のキーボード間の接続 | 青: 左側と接続済み<br>黄: 右側とのペアリング待ち（接続先の右側の電源が入っていない/見つからない）<br>赤: 左側と未接続 |
