...
4. トッププレートを固定している4箇所のM2ネジを外し、PCB、トッププレート、キースイッチが一体になった部品をベースケースから慎重に取り出します。バッテリーやケーブルを引っ張らないように注意してください。
5. 古いスイッチとトッププレートを外します。スイッチのピンを曲げないように、無理にこじらずまっすぐ外してください。
6. 交換先のトッププレートに交換先のスイッチをはめ込みます。ここからはケースビルドガイドの[4. キースイッチ取り付け](03-CASE.md#4-キースイッチ取り付け)から進めます。
7. 続けて[5. トッププレートの取り付け](03-CASE.md#5-トッププレートの取り付け)、[7. PCBの取り付け](03-CASE.md#7-pcbの取り付け)、[10. トップカバーの取り付け](03-CASE.md#10-トップカバーの取り付け)、[11. キーキャップの取り付け](03-CASE.md#11-キーキャップの取り付け)を行います。
8. 組み直したあと、左右の電源をONにして、すべてのキーが入力できることを確認します。
