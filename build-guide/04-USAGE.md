...
CLEAVE HHJPは、MX互換スイッチとChocV1/V2互換スイッチの両方のホットスワップソケットを実装している場合、スイッチとトッププレートを交換して相互に切り替えられます。交換先のスイッチに合ったトッププレート、キーキャップ、トッププレート固定ネジを用意してください。

トッププレート固定ネジはケース方式によって異なります。

| ケース方式 | Chocトッププレート | MXトッププレート | 参照先 |
|---|---|---|---|
| 標準ケース | M2 8mm | M2 10mm | [標準ケースビルドガイド](03-0-STANDARD_CASE.md) |
| 簡易ケースキット | M2 5mm | M2 8mm | [簡易ケースビルドガイド](03-1-SIMPLE_CASE.md) |
| オリジナルケース | 設計したケースに合わせる | 設計したケースに合わせる | [オリジナルケース作成ガイド](03-2-CUSTOM_CASE.md) |
...
- 交換先のスイッチとキーキャップ
- 使用しているケース方式と交換先のトッププレートに合ったM2ネジ
...
2. キーキャップを外します。
3. 標準ケースビルドガイドの[10. トップカバーの取り付け](03-0-STANDARD_CASE.md#10-トップカバーの取り付け)を参考に、トップカバーのM2 4mmネジを外してトップカバーを外します。簡易ケースキットの場合は[簡易ケースガイドの8. トップカバーの取り付け](03-1-SIMPLE_CASE.md#8-トップカバーの取り付け)を参考にします。
...
7. 交換先のトッププレートに交換先のスイッチをはめ込みます。標準ケースでは[標準ケースガイドの4. キースイッチ取り付け](03-0-STANDARD_CASE.md#4-キースイッチ取り付け)、簡易ケースでは[簡易ケースガイドの4. キースイッチ取り付け](03-1-SIMPLE_CASE.md#4-キースイッチ取り付け)から進めます。
8. 標準ケースでは続けて[5. トッププレートの取り付け](03-0-STANDARD_CASE.md#5-トッププレートの取り付け)、[7. PCBの取り付け](03-0-STANDARD_CASE.md#7-pcbの取り付け)、[8. バッテリーの固定](03-0-STANDARD_CASE.md#8-バッテリーの固定)、[10. トップカバーの取り付け](03-0-STANDARD_CASE.md#10-トップカバーの取り付け)、[11. キーキャップの取り付け](03-0-STANDARD_CASE.md#11-キーキャップの取り付け)を行います。簡易ケースでは[5. トッププレートの取り付け](03-1-SIMPLE_CASE.md#5-トッププレートの取り付け)、[6. PCBの取り付け](03-1-SIMPLE_CASE.md#6-pcbの取り付け)、[7. バッテリーの固定](03-1-SIMPLE_CASE.md#7-バッテリーの固定)、[8. トップカバーの取り付け](03-1-SIMPLE_CASE.md#8-トップカバーの取り付け)を行います。
