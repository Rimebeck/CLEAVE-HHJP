...
お手軽キットは、基板の電子部品実装、ファームウェア書き込み、基板単体での動作確認が完了しています。組み立てを始める前に、以下を確認してください。
...
> [!NOTE]
> Chocスイッチを使用する場合、PCBとトッププレートの隙間が微小になりますが、接触することはありません。接触している場合は、スイッチがトッププレートに完全にはまっていない状態のことがあります。
>
> 参考画像：
