...
スイッチの種類によっては位置合わせ穴に隙間ができる場合がありますが、ケース装着時にトッププレートで固定するため問題ありません。
...
組み立て後に左右それぞれのXIAO nRF52840 Plusへファームウェアを書き込みます。手順は以下を参照してください。

[Cleave HHJP ファームウェア書き込みガイド](FIRMWARE.md)
