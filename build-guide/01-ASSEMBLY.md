...
|XIAOを基盤のオモテ面に乗せて"その上から"ピンヘッダで位置合わせをする|両側の端のはんだパッド１つをハンダ付けして仮止めしてピンヘッダを抜く|
|---|---|
| <img src="./images/assembly/05/1.jpg" width="100%"> | <img src="./images/assembly/05/2.jpg" width="100%"> |

そのあと本ハンダ付けをして全てのパッドをハンダ付けします。
